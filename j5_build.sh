...
touch \
    ...
    ./src/tros/examples/rclpy/COLCON_IGNORE \
    ./src/tros/examples/rclcpp/actions/COLCON_IGNORE \
    ./src/tros/examples/rclcpp/composition/COLCON_IGNORE \
    ./src/tros/examples/rclcpp/executors/COLCON_IGNORE \
    ./src/tros/examples/rclcpp/services/COLCON_IGNORE \
    ./src/tros/examples/rclcpp/timers/COLCON_IGNORE \
